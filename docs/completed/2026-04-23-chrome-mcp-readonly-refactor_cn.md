...
> 说明：本文档记录的是 2026-04-23 的“只读化重构”完成态，属于历史基线。2026-04-24 起的增量实现与现行验收口径，见：
...
| 日期 | 修改人 | 内容 |
|---|---|---|
| 2026-04-23 | Cursor Agent | 归档：标记**已完成**，从 `docs/plan/active/` 移至 `docs/completed/`；相对链接从三层 `../` 改为两层（源码与根目录引用）；recruit-agent 分析文档链接改为三层 `../../../recruit-agent/...` |
